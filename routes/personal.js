...
api.get('/personal-hj/:id',md_auth.ensureAuth, PersonalController.gethijos);
...
api.post('/curso-materia/:id',md_auth.ensureAuth, PersonalController.agregaCursoMateria);
api.get('/lista-curso-materia/:id',md_auth.ensureAuth, PersonalController.getCurMatProfe);
module.exports=api;